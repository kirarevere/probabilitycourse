...
\begin{align}
  ...
  \nonumber &=\int_{-\infty}^{\infty} f_{X}(w)f_Y(z-w)dw=\int_{-\infty}^{\infty} f_{Y}(w)f_X(z-w)dw.
\end{align}
</li></ul>
</li></ul></div><hr /><br />
<!-- /Example -->
...
\begin{align}
  \nonumber f_Z(z)=\int_{-\infty}^{\infty} f_{XY}(w,z-w)dw=\int_{-\infty}^{\infty} f_{XY}(z-w,w)dw.
\end{align}
...
\begin{align}
  ...
  \nonumber &=\frac{1}{\sqrt{4 \pi}} e^{\frac{-z^2}{4}},
\end{align}
</li></ul>
</li></ul></div><hr /><br />
