...
\begin{align}%\label{}
\nonumber  P\bigg((X_1,X_2,\cdots,X_n) \in A \bigg)=\int \cdots\int \limits_A\cdots  \int  f_{X_1X_2 \cdots X_n}(x_1,x_2, \cdots ,x_n)\hs dx_1dx_2 \cdots dx_n.
\end{align}
The marginal PDF of $X_i$ can be obtained by integrating all other $X_j$'s. For example,
\begin{align}%\label{}
\nonumber  f_{X_1}(x_1)=\int_{-\infty}^{\infty} \cdots \int_{-\infty}^{\infty}   f_{X_1X_2...X_n}(x_1,x_2,...,x_n)\hs dx_2 \cdots dx_n.
\end{align}
