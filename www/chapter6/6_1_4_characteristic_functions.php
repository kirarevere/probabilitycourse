...
<!-- section content -->
There are random variables for which the moment generating function does not exist on any real interval with positive length. For example, consider the random variable $X$ that has a <i>Cauchy</i> distribution
\begin{align}%\label{}
